...
public class Login extends Template {
    ...
    public String printContent(boolean error) {
        String content = "<div class=\"jumbotron presentation\">                     <h1>Bienvenido a Ferreter&iacute;a!</h1>                     <p>Inicia sesi&oacute;n para entrar al sistema de compras.</p>";
