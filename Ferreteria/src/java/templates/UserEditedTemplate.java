 ...
 */
public class UserEditedTemplate extends Template {

    private boolean error;
    public UserEditedTemplate(boolean error) {
        this.error = error;
    }
    ...
    public String printContent(Object data) {
        ...
        content += "<div class=\"jumbotron\">                    <h1>Editar Usuario</h1>";

        if (!error) {
            content += "<p class=\"lead\">Usuario editado exitosamente.</p>";
        } else {
            content += "<p class=\"lead\">Usuario no editado debido a error interno.</p>";
        }
